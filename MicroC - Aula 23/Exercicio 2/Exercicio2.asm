...
;Exercicio2.c,18 :: 		void CustomChar(char pos_row, char pos_char) {
;Exercicio2.c,20 :: 		Lcd_Cmd(64);
	MOVLW       64
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;Exercicio2.c,21 :: 		for (i = 0; i<=7; i++) Lcd_Chr_CP(character[i]);
...
L_CustomChar0:
	...
	GOTO        L_CustomChar0
L_CustomChar1:
;Exercicio2.c,22 :: 		Lcd_Cmd(_LCD_RETURN_HOME);
	MOVLW       2
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;Exercicio2.c,23 :: 		Lcd_Chr(pos_row, pos_char, 0);
...
;Exercicio2.c,28 :: 		void CustomChar2(char pos_row, char pos_char) {
;Exercicio2.c,30 :: 		Lcd_Cmd(72);
	MOVLW       72
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;Exercicio2.c,31 :: 		for (i = 0; i<=7; i++) Lcd_Chr_CP(character2[i]);
...
L_CustomChar23:
	...
	GOTO        L_CustomChar23
L_CustomChar24:
;Exercicio2.c,32 :: 		Lcd_Cmd(_LCD_RETURN_HOME);
	MOVLW       2
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;Exercicio2.c,33 :: 		Lcd_Chr(pos_row, pos_char, 1);
...
;Exercicio2.c,35 :: 		void main() {
;Exercicio2.c,37 :: 		Lcd_Init();
	CALL        _Lcd_Init+0, 0
;Exercicio2.c,38 :: 		CustomChar(1,1);
	MOVLW       1
	MOVWF       FARG_CustomChar_pos_row+0 
	MOVLW       1
	MOVWF       FARG_CustomChar_pos_char+0 
	CALL        _CustomChar+0, 0
;Exercicio2.c,39 :: 		CustomChar2(2,1);
	MOVLW       2
